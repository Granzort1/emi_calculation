...
if __name__ == '__main__':
    # 입력 파일 경로
    input_file = 'C:/dense_traffic_emi/input/UD_s_Line2.xlsx'
    # 출력 파일 경로
    output_dir = 'C:/dense_traffic_emi/output/UD_TS_emi_line2'
    
    # 입력 데이터 로드
    inputdata = pd.read_excel(input_file)
    ...
    # 배출량 계산 함수 호출 (output_dir 추가)
    calculate_emissions(inputdata, VKT, V, T, ta_min=ta_min, ta_rise=ta_rise, 
                      P_4N=P_4N, sL=sL, output_dir=output_dir)
